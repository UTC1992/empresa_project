...
<div class="container">
	...
	<fieldset class="form-control">
		...
		<?php } ?>
		<div class="">
			<a class="btn btn-outline-primary" href="<?= base_url()?>Controller_Home/vaciar_tbl_manual">Limpiar tabla</a>
		</div>
		<br>
		<?php if($mensaje == "2") { ?>
		...
		<?php }?>
		<div class="">
			<a class="btn btn-warning" href="<?= base_url()?>Controller_Home/buscar_medidor">Buscar por Medidor</a>
			<a class="btn btn-success" href="<?= base_url()?>Controller_Home/buscar_cuenta">Buscar por Cuenta</a>
		</div>
		<br>
	...
	<fieldset class="form-control">
		...
		<form class="" action='<?=base_url()?>Controller_Home/buscar_medidor' method='post' >
		...
		<form class="" action='<?=base_url()?>Controller_Home/buscar_cuenta' method='post' >
			<div class="input-group col-sm-5">
